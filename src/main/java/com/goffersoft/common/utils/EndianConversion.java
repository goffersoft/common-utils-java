...
public class EndianConversion {
    ...
    static private long toLongBE(long longVal, byte byteVal, int bytePos,
            int num_bytes_in_long) {
    ...
    public static OutputStream intToOutputStreamLE(OutputStream os, long value)
            throws IOException {
    ...
    public static OutputStream shortToOutputStreamLE(OutputStream os, long value)
            throws IOException {
    ...
    public static OutputStream longToOutputStreamLE(OutputStream os,
    ...
    public static byte[] longToByteArrayBE(byte[] byteArray, int offset,
        ...
        return toByteArrayBE(byteArray, offset, byteArray.length, num_bytes,
                value);
    }
