...
public class OfpQueueDescMaxRateProp extends OfpQueueDescGenericProp {
    ...
    public static final int OFP_MAX_RATE_HDR_LEN = 2;

    public OfpQueueDescMaxRateProp() {
        super(OfpQueueDescPropType.OFPQDPT_MAX_RATE,
                (short) (OFP_QUEUE_DESC_PROP_BASE_LEN + OFP_MAX_RATE_HDR_LEN));
        setRate((short) 0);
    }
