...
public class TcpServerListenerImpl 
				extends  GenericConnectionListenerImpl
				implements		TcpServerListener {
	
	private static final Logger log = Logger.getLogger(TcpServerListenerImpl.class);
	...
	public void onIncomingConnection(TcpServer tcp_server,
		...
		log.info("Factory Default Listener Installed: New Incoming TCP Connection : \n" + tcp_conn.toString());
