/**
 ** File: GenericTcpConnectionListener.java
 **
 ** Description : GenericTcpConnectionListener interface - listener interface
 **               code common to all tcp connection types
 **
...
public interface GenericTcpConnectionListener<TcpConnectionType>
        extends
